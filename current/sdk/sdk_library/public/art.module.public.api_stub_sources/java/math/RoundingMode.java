 ...
 * enumeration of rounding mode constants in {@link java.math.BigDecimal BigDecimal}
 * ({@link java.math.BigDecimal#ROUND_UP BigDecimal#ROUND_UP}, {@link java.math.BigDecimal#ROUND_DOWN BigDecimal#ROUND_DOWN},
 * etc. ).
 *
 ...
 * legacy integer rounding mode constant in {@link java.math.BigDecimal BigDecimal}.
 *
 * @param  rm legacy integer rounding mode to convert
 * @return {@code RoundingMode} corresponding to the given integer.
 * @throws java.lang.IllegalArgumentException integer is out of range
 */

public static java.math.RoundingMode valueOf(int rm) { throw new RuntimeException("Stub!"); }
}
