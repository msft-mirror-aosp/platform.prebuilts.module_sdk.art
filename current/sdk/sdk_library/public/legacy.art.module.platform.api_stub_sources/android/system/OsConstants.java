 ...
 * Has to be used as a first argument for {@link android.system.Os#prctl(int,long,long,long,long) Os#prctl(int, long, long, long, long)}.
 *
...
/**
 * The capability specified in {@code arg3} of {@link android.system.Os#prctl(int,long,long,long,long) Os#prctl(int, long, long, long, long)}
 ...
 * Has to be used as a second argument for {@link android.system.Os#prctl(int,long,long,long,long) Os#prctl(int, long, long, long, long)}.
 *
 * See <a href="https://man7.org/linux/man-pages/man2/prctl.2.html">prctl(2)</a>.
 * @hide
 */
 ...
 *
 * <p>Attempts ({@link android.system.Os#open(java.lang.String,int,int) Os#open(String, int, int)}, {@link android.system.Os#pipe() Os#pipe()},
 * {@link android.system.Os#dup(java.io.FileDescriptor) Os#dup(java.io.FileDescriptor)}, etc.) to exceed this
 ...
 * Used in {@link android.system.NetlinkSocketAddress NetlinkSocketAddress}.
 *
...
/**
 * {@code flags} option for {@link android.system.Os#setxattr(java.lang.String,java.lang.String,byte[],int) Os#setxattr(String, String, byte[], int)}.
 *
