 ...
 * A {@link android.system.NetlinkSocketAddress NetlinkSocketAddress} can be either unicast (only sent to one peer)
 * or sent to netlink multicast groups ({@code nlGroupsMask} not equal 0).
 *
 * Any {@link android.system.NetlinkSocketAddress NetlinkSocketAddress} is described by {@code nlPortId} and {@code nlGroupsMask}.
 *
