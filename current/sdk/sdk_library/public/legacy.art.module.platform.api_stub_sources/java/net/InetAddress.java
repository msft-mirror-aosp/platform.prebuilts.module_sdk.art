 ...
 * {@link java.net.InetAddress InetAddress} class documentation. An empty string is not treated as numeric.
 *
 * @hide used by frameworks/base to ensure that a getAllByName won't cause a DNS lookup.
 * @deprecated Use {@link libcore.net.InetAddressUtils#isNumericAddress(java.lang.String) InetAddressUtils#isNumericAddress(String)} instead, if possible.
 * @throws java.lang.NullPointerException if the {@code address} is {@code null}.
 */
 ...
 * {@link java.net.Inet6Address#LOOPBACK Inet6Address#LOOPBACK} address.
 *
 * @hide used by frameworks/base's NetworkUtils.numericToInetAddress
 * @throws java.lang.IllegalArgumentException if {@code numericAddress} is not a numeric address
 * @deprecated Use {@link libcore.net.InetAddressUtils#parseNumericAddress(java.lang.String) InetAddressUtils#parseNumericAddress(String)} instead, if possible.
 */
